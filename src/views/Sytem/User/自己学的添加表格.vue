  ...
  >
    ...
    >
      <el-form-item label="用户名" prop="username">
        <el-input v-model="addOrUpdateFormData.username"></el-input>
      </el-form-item>
      <el-form-item label="电话" prop="phone">
        <el-input v-model="addOrUpdateFormData.phone"></el-input>
      </el-form-item>
      <el-form-item label="昵称" prop="nickName">
        <el-input v-model="addOrUpdateFormData.nickName"></el-input>
      </el-form-item>
      <el-form-item label="邮箱" prop="email">
        <el-input v-model="addOrUpdateFormData.email"></el-input>
      </el-form-item>
